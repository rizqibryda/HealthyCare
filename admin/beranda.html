...
<body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link active" href="/admin/beranda.html">Beranda</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/admin/cetakResep.html">Cetak Resep</a>
            </li>
  ...
  <section id="text-intro-section" class="parallax" data-stellar-background-ratio="0.5" style="background-image: url(/admin/assets/img/bg-healthycare.png);">
